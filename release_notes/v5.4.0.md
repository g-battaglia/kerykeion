...
-   Numerous under `tests/data/svg/*.svg`
...
-   DualReturn charts now **visually** match Synastry more closely; any code or tests that relied on the old, more Transit-like layout will need to be updated to the new golden SVGs (already done in `tests/data/svg`).
