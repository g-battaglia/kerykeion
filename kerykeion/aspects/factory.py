...
https://www.kerykeion.net/python-library/docs/v6/aspects for the full reference.
...
from kerykeion.astrological_subject.factory import AstrologicalSubjectFactory, OPPOSITE_PAIRS
