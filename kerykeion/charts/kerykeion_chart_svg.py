...
if __name__ == "__main__":
    ...
    hindi_chart.makePNG()
    russian_chart.makePNG()
    turkish_chart.makePNG()
    german_chart.makePNG()
    italian_chart.makePNG()
    portuguese_chart.makePNG()
    spanish_chart.makePNG()
    french_chart.makePNG()
    chinese_chart.makePNG()
    transits_chart.makePNG()
    transit_chart_with_table_grid.makePNG()
    synastry_chart_with_table_list.makePNG()
    aspect_grid_dark_synastry_chart.makePNG()
    aspect_grid_light_chart.makePNG()
    aspect_grid_dark_chart.makePNG()
    aspect_grid_only_chart.makePNG()
    aspect_grid_transit_chart.makePNG()
    aspect_grid_synastry_chart.makePNG()
    wheel_synastry_chart.makePNG()
