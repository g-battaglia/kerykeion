...
_DOUBLE_CHART_TYPES: tuple[ChartType, ...] = ("Synastry", "Transit", "DualReturnChart", "Progression")
    ...
    for i in range(xr):
        ...
        if chart_type in _DOUBLE_CHART_TYPES:
            if second_subject_houses_list is None or transit_house_cusp_color is None:
                raise KerykeionException("second_subject_houses_list or house_cusp_color is None for dual-wheel chart")
        ...
        if external_view:
            ...
            dropin = 84 if chart_type in _DOUBLE_CHART_TYPES else 48
