...
class KerykeionLanguageCelestialPointModel(SubscriptableBaseModel):
    ...
    True_North_Node: str = Field(title="True North Node", description="The name of True North Node in the chart, in the language")
    Mean_North_Node: str = Field(title="Mean North Node", description="The name of Mean North Node in the chart, in the language")
