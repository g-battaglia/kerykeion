...
| `generate_cli_manpage.py` | `man:generate` | `cli/man/man1/kerykeion.1` — the shipped `kerykeion(1)` page, rendered from the CLI's argparse tree; `poe man:check` is the drift gate. |
