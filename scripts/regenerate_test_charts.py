...
first = AstrologicalSubjectFactory.from_birth_data("John Lennon", 1940, 10, 9, 18, 30, "Liverpool", "GB", geonames_username="century.boy")
...
internal_natal_chart = KerykeionChartSVG(first, new_output_directory=OUTPUT_DIR_STR)
internal_natal_chart.makeSVG()

# External Natal Chart
external_natal_chart = KerykeionChartSVG(first, "ExternalNatal", second, new_output_directory=OUTPUT_DIR_STR)
external_natal_chart.makeSVG()

# Synastry Chart
synastry_chart = KerykeionChartSVG(first, "Synastry", second, new_output_directory=OUTPUT_DIR_STR)
synastry_chart.makeSVG()

# Transits Chart
transits_chart = KerykeionChartSVG(first, "Transit", second, new_output_directory=OUTPUT_DIR_STR)
...
sidereal_chart = KerykeionChartSVG(sidereal_subject, new_output_directory=OUTPUT_DIR_STR)
...
morinus_house_chart = KerykeionChartSVG(morinus_house_subject, new_output_directory=OUTPUT_DIR_STR)
...
#     alternatives_house_chart = KerykeionChartSVG(alternatives_house_subject, new_output_directory=OUTPUT_DIR_STR)
...
true_geocentric_chart = KerykeionChartSVG(true_geocentric_subject, new_output_directory=OUTPUT_DIR_STR)
...
heliocentric_chart = KerykeionChartSVG(heliocentric_subject, new_output_directory=OUTPUT_DIR_STR)
...
topocentric_chart = KerykeionChartSVG(topocentric_subject, new_output_directory=OUTPUT_DIR_STR)
...
minified_chart = KerykeionChartSVG(minified_subject, new_output_directory=OUTPUT_DIR_STR)
...
dark_theme_natal_chart = KerykeionChartSVG(dark_theme_subject, theme="dark", new_output_directory=OUTPUT_DIR_STR)
...
dark_high_contrast_theme_natal_chart = KerykeionChartSVG(dark_high_contrast_theme_subject, theme="dark-high-contrast", new_output_directory=OUTPUT_DIR_STR)
...
light_theme_natal_chart = KerykeionChartSVG(light_theme_subject, theme="light", new_output_directory=OUTPUT_DIR_STR)
...
dark_theme_external_chart = KerykeionChartSVG(dark_theme_external_subject, "ExternalNatal", second, theme="dark", new_output_directory=OUTPUT_DIR_STR)
...
dark_theme_synastry_chart = KerykeionChartSVG(dark_theme_synastry_subject, "Synastry", second, theme="dark", new_output_directory=OUTPUT_DIR_STR)
...
wheel_only_chart = KerykeionChartSVG(wheel_only_subject, new_output_directory=OUTPUT_DIR_STR)
...
wheel_external_chart = KerykeionChartSVG(wheel_external_subject, "ExternalNatal", second, new_output_directory=OUTPUT_DIR_STR)
...
wheel_synastry_chart = KerykeionChartSVG(wheel_synastry_subject, "Synastry", second, new_output_directory=OUTPUT_DIR_STR)
...
wheel_transit_chart = KerykeionChartSVG(wheel_transit_subject, "Transit", second, new_output_directory=OUTPUT_DIR_STR)
...
sidereal_dark_chart = KerykeionChartSVG(sidereal_dark_subject, theme="dark", new_output_directory=OUTPUT_DIR_STR)
...
sidereal_light_chart = KerykeionChartSVG(sidereal_light_subject, theme="light", new_output_directory=OUTPUT_DIR_STR)
...
aspect_grid_only_chart = KerykeionChartSVG(aspect_grid_only_subject, new_output_directory=OUTPUT_DIR_STR)
...
aspect_grid_dark_chart = KerykeionChartSVG(aspect_grid_dark_subject, theme="dark", new_output_directory=OUTPUT_DIR_STR)
...
aspect_grid_light_chart = KerykeionChartSVG(aspect_grid_light_subject, theme="light", new_output_directory=OUTPUT_DIR_STR)
...
aspect_grid_synastry_chart = KerykeionChartSVG(aspect_grid_synastry_subject, "Synastry", second, new_output_directory=OUTPUT_DIR_STR)
...
aspect_grid_transit_chart = KerykeionChartSVG(aspect_grid_transit_subject, "Transit", second, new_output_directory=OUTPUT_DIR_STR)
...
aspect_grid_dark_synastry_chart = KerykeionChartSVG(aspect_grid_dark_synastry_subject, "Synastry", second, theme="dark", new_output_directory=OUTPUT_DIR_STR)
...
synastry_chart_with_table_list = KerykeionChartSVG(synastry_chart_with_table_list_subject, "Synastry", second, double_chart_aspect_grid_type="list", theme="dark", new_output_directory=OUTPUT_DIR_STR)
...
transit_chart_with_table_grid = KerykeionChartSVG(transit_chart_with_table_grid_subject, "Transit", second, double_chart_aspect_grid_type="table", theme="dark", new_output_directory=OUTPUT_DIR_STR)
...
chinese_chart = KerykeionChartSVG(chinese_subject, chart_language="CN", new_output_directory=OUTPUT_DIR_STR)
...
french_chart = KerykeionChartSVG(french_subject, chart_language="FR", new_output_directory=OUTPUT_DIR_STR)
...
spanish_chart = KerykeionChartSVG(spanish_subject, chart_language="ES", new_output_directory=OUTPUT_DIR_STR)
...
portuguese_chart = KerykeionChartSVG(portuguese_subject, chart_language="PT", new_output_directory=OUTPUT_DIR_STR)
...
italian_chart = KerykeionChartSVG(italian_subject, chart_language="IT", new_output_directory=OUTPUT_DIR_STR)
...
russian_chart = KerykeionChartSVG(russian_subject, chart_language="RU", new_output_directory=OUTPUT_DIR_STR)
...
turkish_chart = KerykeionChartSVG(turkish_subject, chart_language="TR", new_output_directory=OUTPUT_DIR_STR)
...
german_chart = KerykeionChartSVG(german_subject, chart_language="DE", new_output_directory=OUTPUT_DIR_STR)
...
hindi_chart = KerykeionChartSVG(hindi_subject, chart_language="HI", new_output_directory=OUTPUT_DIR_STR)
hindi_chart.makeSVG()
...
kanye_west_chart = KerykeionChartSVG(kanye_west_subject, new_output_directory=OUTPUT_DIR_STR)
kanye_west_chart.makeSVG()

# Composite Chart
angelina = AstrologicalSubjectFactory.from_birth_data("Angelina Jolie", 1975, 6, 4, 9, 9, "Los Angeles", "US", lng=-118.15, lat=34.03, tz_str="America/Los_Angeles", geonames_username="century.boy")
brad = AstrologicalSubjectFactory.from_birth_data("Brad Pitt", 1963, 12, 18, 6, 31, "Shawnee", "US", lng=-96.56, lat=35.20, tz_str="America/Chicago", geonames_username="century.boy")
...
composite_chart = KerykeionChartSVG(composite_subject_model, "Composite", new_output_directory=OUTPUT_DIR_STR)
...
transparent_background_chart = KerykeionChartSVG(transparent_background_subject, transparent_background=True, new_output_directory=OUTPUT_DIR_STR)
