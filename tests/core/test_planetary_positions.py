...
from tests.tolerance_config import POSITION_TOL, SPEED_TOL, get_tolerance_for_body
...
SPEED_ABS_TOL = SPEED_TOL  # Use centralized config
...
class TestTemporalPlanetaryPositions:
    ...
    def test_planet_abs_pos(self, temporal_subject_id: str, planet: str):
        ...
        assert actual_point.abs_pos == approx(planet_data["abs_pos"], abs=POSITION_TOL), (
    ...
    def test_planet_position(self, temporal_subject_id: str, planet: str):
        ...
        assert actual_point.position == approx(planet_data["position"], abs=POSITION_TOL), (
    ...
    def test_planet_speed(self, temporal_subject_id: str, planet: str):
        ...
        assert actual_point.speed == approx(planet_data["speed"], abs=SPEED_TOL), (
