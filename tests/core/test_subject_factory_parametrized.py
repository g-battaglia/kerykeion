...
Tests are organized by configuration type for easy filtering:
    pytest tests/core/test_subject_factory_parametrized.py -k "house_system"
    pytest tests/core/test_subject_factory_parametrized.py -k "sidereal"
    pytest tests/core/test_subject_factory_parametrized.py -k "perspective"
"""
...
class TestPerspectiveConfigurations:
    ...
    def test_perspective_creates_valid_subject(self, perspective_type):
        ...
        from kerykeion.astrological_subject.factory import _center_body_names
