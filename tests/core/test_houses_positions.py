...
# =============================================================================
# TOLERANCE - Use centralized config
# =============================================================================
...
class TestTemporalHousePositions:
    ...
    def test_house_abs_pos(self, temporal_subject_id: str, house: str):
        ...
        assert actual_house.abs_pos == approx(house_data["abs_pos"], abs=POSITION_TOL), (
    ...
    def test_house_position(self, temporal_subject_id: str, house: str):
        ...
        assert actual_house.position == approx(house_data["position"], abs=POSITION_TOL), (
...
class TestHouseSystemVariations:
    ...
    def test_placidus_vs_whole_sign(self):
        ...
        # In Whole Sign, cusps are at 0° of each sign, not aligned with Ascendant
        # So first house cusp should be at 0° of Ascendant's sign
        asc_sign_num = placidus.ascendant.sign_num
        expected_whole_sign_first = asc_sign_num * 30.0

        # Verify Whole Sign starts at 0° of the sign
        assert whole_sign.first_house.abs_pos == approx(expected_whole_sign_first, abs=0.1), (
            f"Whole Sign first house should be at {expected_whole_sign_first}°"
        )
