...
sidereal_subject = AstrologicalSubjectFactory.from_standard("John Lennon Lahiri", 1940, 10, 9, 18, 30, "Liverpool", "GB", zodiac_type="Sidereal", sidereal_mode="LAHIRI")
sidereal_chart = KerykeionChartSVG(sidereal_subject)
sidereal_chart.makeSVG()

# Sidereal Birth Chart (Fagan-Bradley)
sidereal_subject = AstrologicalSubjectFactory.from_standard("John Lennon Fagan-Bradley", 1940, 10, 9, 18, 30, "Liverpool", "GB", zodiac_type="Sidereal", sidereal_mode="FAGAN_BRADLEY")
sidereal_chart = KerykeionChartSVG(sidereal_subject)
sidereal_chart.makeSVG()

# Sidereal Birth Chart (DeLuce)
sidereal_subject = AstrologicalSubjectFactory.from_standard("John Lennon DeLuce", 1940, 10, 9, 18, 30, "Liverpool", "GB", zodiac_type="Sidereal", sidereal_mode="DELUCE")
sidereal_chart = KerykeionChartSVG(sidereal_subject)
sidereal_chart.makeSVG()

# Sidereal Birth Chart (J2000)
sidereal_subject = AstrologicalSubjectFactory.from_standard("John Lennon J2000", 1940, 10, 9, 18, 30, "Liverpool", "GB", zodiac_type="Sidereal", sidereal_mode="J2000")
sidereal_chart = KerykeionChartSVG(sidereal_subject)
sidereal_chart.makeSVG()

# House System Morinus
morinus_house_subject = AstrologicalSubjectFactory.from_standard("John Lennon - House System Morinus", 1940, 10, 9, 18, 30, "Liverpool", "GB", houses_system_identifier="M")
...
#     alternatives_house_subject = AstrologicalSubjectFactory.from_standard(f"John Lennon - House System {i}", 1940, 10, 9, 18, 30, "Liverpool", "GB", houses_system=i)
...
true_geocentric_subject = AstrologicalSubjectFactory.from_standard("John Lennon - True Geocentric", 1940, 10, 9, 18, 30, "Liverpool", "GB", perspective_type="True Geocentric")
...
heliocentric_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Heliocentric", 1940, 10, 9, 18, 30, "Liverpool", "GB", perspective_type="Heliocentric")
heliocentric_chart = KerykeionChartSVG(heliocentric_subject)
heliocentric_chart.makeSVG()

# With Topocentric Perspective
topocentric_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Topocentric", 1940, 10, 9, 18, 30, "Liverpool", "GB", perspective_type="Topocentric")
topocentric_chart = KerykeionChartSVG(topocentric_subject)
topocentric_chart.makeSVG()

# Minified SVG
minified_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Minified", 1940, 10, 9, 18, 30, "Liverpool", "GB")
minified_chart = KerykeionChartSVG(minified_subject)
minified_chart.makeSVG(minify=True)

# Dark Theme Natal Chart
dark_theme_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Dark Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB")
dark_theme_natal_chart = KerykeionChartSVG(dark_theme_subject, theme="dark")
dark_theme_natal_chart.makeSVG()

# Dark High Contrast Theme Natal Chart
dark_high_contrast_theme_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Dark High Contrast Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
light_theme_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Light Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
dark_theme_external_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Dark Theme External", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
dark_theme_synastry_subject = AstrologicalSubjectFactory.from_standard("John Lennon - DTS", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
wheel_only_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Wheel Only", 1940, 10, 9, 18, 30, "Liverpool", "GB")
wheel_only_chart = KerykeionChartSVG(wheel_only_subject)
wheel_only_chart.makeWheelOnlySVG()

# Wheel External Natal Only Chart
wheel_external_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Wheel External Only", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
wheel_synastry_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Wheel Synastry Only", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
wheel_transit_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Wheel Transit Only", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
sidereal_dark_subject = AstrologicalSubjectFactory.from_standard("John Lennon Lahiri - Dark Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB", zodiac_type="Sidereal", sidereal_mode="LAHIRI")
...
sidereal_light_subject = AstrologicalSubjectFactory.from_standard("John Lennon Fagan-Bradley - Light Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB", zodiac_type="Sidereal", sidereal_mode="FAGAN_BRADLEY")
...
aspect_grid_only_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Aspect Grid Only", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
aspect_grid_dark_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Aspect Grid Dark Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
aspect_grid_light_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Aspect Grid Light Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
aspect_grid_synastry_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Aspect Grid Synastry", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
aspect_grid_transit_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Aspect Grid Transit", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
aspect_grid_dark_synastry_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Aspect Grid Dark Synastry", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
synastry_chart_with_table_list_subject = AstrologicalSubjectFactory.from_standard("John Lennon - SCTWL", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
transit_chart_with_table_grid_subject = AstrologicalSubjectFactory.from_standard("John Lennon - TCWTG", 1940, 10, 9, 18, 30, "Liverpool", "GB")
...
chinese_subject = AstrologicalSubjectFactory.from_standard("Hua Chenyu", 1990, 2, 7, 12, 0, "Hunan", "CN")
chinese_chart = KerykeionChartSVG(chinese_subject, chart_language="CN")
chinese_chart.makeSVG()

# French Language Chart
french_subject = AstrologicalSubjectFactory.from_standard("Jeanne Moreau", 1928, 1, 23, 10, 0, "Paris", "FR")
french_chart = KerykeionChartSVG(french_subject, chart_language="FR")
french_chart.makeSVG()

# Spanish Language Chart
spanish_subject = AstrologicalSubjectFactory.from_standard("Antonio Banderas", 1960, 8, 10, 12, 0, "Malaga", "ES")
spanish_chart = KerykeionChartSVG(spanish_subject, chart_language="ES")
spanish_chart.makeSVG()

# Portuguese Language Chart
portuguese_subject = AstrologicalSubjectFactory.from_standard("Cristiano Ronaldo", 1985, 2, 5, 5, 25, "Funchal", "PT")
portuguese_chart = KerykeionChartSVG(portuguese_subject, chart_language="PT")
portuguese_chart.makeSVG()

# Italian Language Chart
italian_subject = AstrologicalSubjectFactory.from_standard("Sophia Loren", 1934, 9, 20, 2, 0, "Rome", "IT")
italian_chart = KerykeionChartSVG(italian_subject, chart_language="IT")
italian_chart.makeSVG()

# Russian Language Chart
russian_subject = AstrologicalSubjectFactory.from_standard("Mikhail Bulgakov", 1891, 5, 15, 12, 0, "Kiev", "UA")
russian_chart = KerykeionChartSVG(russian_subject, chart_language="RU")
russian_chart.makeSVG()

# Turkish Language Chart
turkish_subject = AstrologicalSubjectFactory.from_standard("Mehmet Oz", 1960, 6, 11, 12, 0, "Istanbul", "TR")
turkish_chart = KerykeionChartSVG(turkish_subject, chart_language="TR")
turkish_chart.makeSVG()

# German Language Chart
german_subject = AstrologicalSubjectFactory.from_standard("Albert Einstein", 1879, 3, 14, 11, 30, "Ulm", "DE")
german_chart = KerykeionChartSVG(german_subject, chart_language="DE")
german_chart.makeSVG()

# Hindi Language Chart
hindi_subject = AstrologicalSubjectFactory.from_standard("Amitabh Bachchan", 1942, 10, 11, 4, 0, "Allahabad", "IN")
hindi_chart = KerykeionChartSVG(hindi_subject, chart_language="HI")
hindi_chart.makeSVG()

# Kanye West Natal Chart
kanye_west_subject = AstrologicalSubjectFactory.from_standard("Kanye", 1977, 6, 8, 8, 45, "Atlanta", "US")
kanye_west_chart = KerykeionChartSVG(kanye_west_subject)
kanye_west_chart.makeSVG()

# Composite Chart
angelina = AstrologicalSubjectFactory.from_standard("Angelina Jolie", 1975, 6, 4, 9, 9, "Los Angeles", "US", lng=-118.15, lat=34.03, tz_str="America/Los_Angeles")
brad = AstrologicalSubjectFactory.from_standard("Brad Pitt", 1963, 12, 18, 6, 31, "Shawnee", "US", lng=-96.56, lat=35.20, tz_str="America/Chicago")
