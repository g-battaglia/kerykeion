...
class TestCharts:
    ...
    # =========================================================================
    # SECTION 16: UNTESTED PARAMETERS TESTS
    # =========================================================================

    def test_theme_none(self):
        """Test natal chart with theme=None (no CSS theme applied)."""
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - No Theme", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data, theme=None).generate_svg_string()
        self._compare_chart_svg("John Lennon - No Theme - Natal Chart.svg", chart_svg)

    def test_show_degree_indicators_false(self):
        """Test natal chart with degree indicators hidden."""
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - No Degree Indicators", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data, show_degree_indicators=False).generate_svg_string()
        self._compare_chart_svg("John Lennon - No Degree Indicators - Natal Chart.svg", chart_svg)
    ...
    def test_custom_colors_settings(self):
        ...
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - Custom Colors", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data, colors_settings=custom_colors).generate_svg_string()
        self._compare_chart_svg("John Lennon - Custom Colors - Natal Chart.svg", chart_svg)
    ...
    def test_custom_aspects_settings(self):
        ...
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - Custom Aspect Colors", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data, aspects_settings=custom_aspects).generate_svg_string()
        self._compare_chart_svg("John Lennon - Custom Aspect Colors - Natal Chart.svg", chart_svg)
    ...
    def test_custom_celestial_points_settings(self):
        ...
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - Custom Planet Colors", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data, celestial_points_settings=custom_points).generate_svg_string()
        self._compare_chart_svg("John Lennon - Custom Planet Colors - Natal Chart.svg", chart_svg)
    ...
    def test_language_pack_override(self):
        ...
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - Language Pack", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(
            chart_data, chart_language="IT", language_pack=custom_language_pack
        ).generate_svg_string()
        self._compare_chart_svg("John Lennon - Language Pack - Natal Chart.svg", chart_svg)

    # =========================================================================
    # SECTION 17: PARAMETER COMBINATIONS TESTS
    # =========================================================================

    def test_transparent_background_dark_theme(self):
        """Test natal chart with transparent background and dark theme."""
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - Transparent Dark", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data, theme="dark", transparent_background=True).generate_svg_string()
        self._compare_chart_svg("John Lennon - Transparent Dark - Natal Chart.svg", chart_svg)

    def test_transparent_background_synastry(self):
        """Test synastry chart with transparent background."""
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - Transparent Synastry", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_synastry_chart_data(subject, self.second_subject)
        chart_svg = ChartDrawer(chart_data, transparent_background=True).generate_svg_string()
        self._compare_chart_svg("John Lennon - Transparent Synastry - Synastry Chart.svg", chart_svg)

    def test_custom_title_synastry(self):
        """Test synastry chart with custom title."""
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - Custom Title Synastry", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_synastry_chart_data(subject, self.second_subject)
        chart_svg = ChartDrawer(chart_data, custom_title="Beatles Synastry Analysis").generate_svg_string()
        self._compare_chart_svg("John Lennon - Custom Title Synastry - Synastry Chart.svg", chart_svg)

    def test_custom_title_transit(self):
        """Test transit chart with custom title."""
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - Custom Title Transit", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_transit_chart_data(subject, self.second_subject)
        chart_svg = ChartDrawer(chart_data, custom_title="Transit Analysis 2024").generate_svg_string()
        self._compare_chart_svg("John Lennon - Custom Title Transit - Transit Chart.svg", chart_svg)

    def test_padding_zero(self):
        """Test natal chart with zero padding."""
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - Zero Padding", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data, padding=0).generate_svg_string()
        self._compare_chart_svg("John Lennon - Zero Padding - Natal Chart.svg", chart_svg)

    def test_padding_large(self):
        """Test natal chart with large padding (100px)."""
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - Large Padding", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data, padding=100).generate_svg_string()
        self._compare_chart_svg("John Lennon - Large Padding - Natal Chart.svg", chart_svg)

    def test_minify_and_remove_css_combined(self):
        """Test natal chart with both minify and remove_css_variables enabled."""
        subject = AstrologicalSubjectFactory.from_birth_data(
            "John Lennon - Minify CSS", *self.JOHN_LENNON_BIRTH_DATA, suppress_geonames_warning=True
        )
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data).generate_svg_string(minify=True, remove_css_variables=True)
        self._compare_chart_svg("John Lennon - Minify CSS - Natal Chart.svg", chart_svg)

    # =========================================================================
    # SECTION 18: EDGE CASES TESTS
    # =========================================================================
    ...
    def test_very_long_name(self):
        ...
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data).generate_svg_string()
        self._compare_chart_svg("Long Name - Natal Chart.svg", chart_svg)
    ...
    def test_extreme_latitude_north(self):
        ...
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data).generate_svg_string()
        self._compare_chart_svg("Arctic Subject - Natal Chart.svg", chart_svg)
    ...
    def test_extreme_latitude_south(self):
        ...
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data).generate_svg_string()
        self._compare_chart_svg("Antarctic Subject - Natal Chart.svg", chart_svg)
    ...
    def test_historical_date(self):
        ...
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data).generate_svg_string()
        self._compare_chart_svg("Historical Subject - Natal Chart.svg", chart_svg)
    ...
    def test_future_date(self):
        ...
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data).generate_svg_string()
        self._compare_chart_svg("Future Subject - Natal Chart.svg", chart_svg)
    ...
    def test_date_line_crossing(self):
        ...
        chart_data = ChartDataFactory.create_natal_chart_data(subject)
        chart_svg = ChartDrawer(chart_data).generate_svg_string()
        self._compare_chart_svg("Date Line Subject - Natal Chart.svg", chart_svg)
    ...
    def test_save_wheel_only_creates_file(self):
    ...
    def test_save_aspect_grid_only_creates_file(self):
