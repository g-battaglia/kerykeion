...
from kerykeion import AstrologicalSubjectFactory, KerykeionChartSVG, CompositeSubjectFactory
...
class TestCharts:
    ...
    def setup_class(self):
        self.first_subject = AstrologicalSubjectFactory.from_standard("John Lennon", 1940, 10, 9, 18, 30, "Liverpool", "GB", geonames_username="century.boy")
        self.second_subject = AstrologicalSubjectFactory.from_standard("Paul McCartney", 1942, 6, 18, 15, 30, "Liverpool", "GB", geonames_username="century.boy")
        self.lahiri_subject = AstrologicalSubjectFactory.from_standard("John Lennon Lahiri", 1940, 10, 9, 18, 30, "Liverpool", "GB", zodiac_type="Sidereal", sidereal_mode="LAHIRI", geonames_username="century.boy")
        self.fagan_bradley_subject = AstrologicalSubjectFactory.from_standard("John Lennon Fagan-Bradley", 1940, 10, 9, 18, 30, "Liverpool", "GB", zodiac_type="Sidereal", sidereal_mode="FAGAN_BRADLEY", geonames_username="century.boy")
        self.deluce_subject = AstrologicalSubjectFactory.from_standard("John Lennon DeLuce", 1940, 10, 9, 18, 30, "Liverpool", "GB", zodiac_type="Sidereal", sidereal_mode="DELUCE", geonames_username="century.boy")
        self.j2000_subject = AstrologicalSubjectFactory.from_standard("John Lennon J2000", 1940, 10, 9, 18, 30, "Liverpool", "GB", zodiac_type="Sidereal", sidereal_mode="J2000", geonames_username="century.boy")
        self.morinus_house_system_subject = AstrologicalSubjectFactory.from_standard("John Lennon - House System Morinus", 1940, 10, 9, 18, 30, "Liverpool", "GB", houses_system_identifier="M", geonames_username="century.boy")
        self.heliocentric_perspective_natal_chart = AstrologicalSubjectFactory.from_standard("John Lennon - Heliocentric", 1940, 10, 9, 18, 30, "Liverpool", "GB", geonames_username="century.boy", perspective_type="Heliocentric")
        self.topocentric_perspective_natal_chart = AstrologicalSubjectFactory.from_standard("John Lennon - Topocentric", 1940, 10, 9, 18, 30, "Liverpool", "GB", geonames_username="century.boy", perspective_type="Topocentric")
        self.true_geocentric_perspective_natal_chart = AstrologicalSubjectFactory.from_standard("John Lennon - True Geocentric", 1940, 10, 9, 18, 30, "Liverpool", "GB", geonames_username="century.boy", perspective_type="True Geocentric")
        self.minified_natal_chart = AstrologicalSubjectFactory.from_standard("John Lennon - Minified", 1940, 10, 9, 18, 30, "Liverpool", "GB", geonames_username="century.boy")
        self.dark_theme_natal_chart = AstrologicalSubjectFactory.from_standard("John Lennon - Dark Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB", geonames_username="century.boy")
        self.dark_high_contrast_theme_natal_chart = AstrologicalSubjectFactory.from_standard("John Lennon - Dark High Contrast Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB", geonames_username="century.boy")
        self.light_theme_natal_chart = AstrologicalSubjectFactory.from_standard("John Lennon - Light Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB", geonames_username="century.boy")
        self.dark_theme_external_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Dark Theme External", 1940, 10, 9, 18, 30, "Liverpool", "GB")
        self.dark_theme_synastry_subject = AstrologicalSubjectFactory.from_standard("John Lennon - DTS", 1940, 10, 9, 18, 30, "Liverpool", "GB")
        self.wheel_only_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Wheel Only", 1940, 10, 9, 18, 30, "Liverpool", "GB")

        self.wheel_external_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Wheel External Only", 1940, 10, 9, 18, 30, "Liverpool", "GB")
        self.wheel_synastry_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Wheel Synastry Only", 1940, 10, 9, 18, 30, "Liverpool", "GB")
        self.wheel_transit_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Wheel Transit Only", 1940, 10, 9, 18, 30, "Liverpool", "GB")
        self.sidereal_dark_subject = AstrologicalSubjectFactory.from_standard("John Lennon Lahiri - Dark Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB", zodiac_type="Sidereal", sidereal_mode="LAHIRI")
        self.sidereal_light_subject = AstrologicalSubjectFactory.from_standard("John Lennon Fagan-Bradley - Light Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB", zodiac_type="Sidereal", sidereal_mode="FAGAN_BRADLEY")
        self.aspect_grid_only_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Aspect Grid Only", 1940, 10, 9, 18, 30, "Liverpool", "GB")
        self.aspect_grid_dark_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Aspect Grid Dark Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB")
        self.aspect_grid_light_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Aspect Grid Light Theme", 1940, 10, 9, 18, 30, "Liverpool", "GB")
        self.aspect_grid_synastry_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Aspect Grid Synastry", 1940, 10, 9, 18, 30, "Liverpool", "GB")
        self.aspect_grid_transit_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Aspect Grid Transit", 1940, 10, 9, 18, 30, "Liverpool", "GB")
        self.aspect_grid_dark_synastry_subject = AstrologicalSubjectFactory.from_standard("John Lennon - Aspect Grid Dark Synastry", 1940, 10, 9, 18, 30, "Liverpool", "GB")
        self.transit_chart_with_table_grid_subject = AstrologicalSubjectFactory.from_standard("John Lennon - TCWTG", 1940, 10, 9, 18, 30, "Liverpool", "GB")

        # Language Tests
        self.chinese_subject = AstrologicalSubjectFactory.from_standard("Hua Chenyu", 1990, 2, 7, 12, 0, "Hunan", "CN")
        self.french_subject = AstrologicalSubjectFactory.from_standard("Jeanne Moreau", 1928, 1, 23, 10, 0, "Paris", "FR")
        self.spanish_subject = AstrologicalSubjectFactory.from_standard("Antonio Banderas", 1960, 8, 10, 12, 0, "Malaga", "ES")
        self.portuguese_subject = AstrologicalSubjectFactory.from_standard("Cristiano Ronaldo", 1985, 2, 5, 5, 25, "Funchal", "PT")
        self.italian_subject = AstrologicalSubjectFactory.from_standard("Sophia Loren", 1934, 9, 20, 2, 0, "Rome", "IT")
        self.russian_subject = AstrologicalSubjectFactory.from_standard("Mikhail Bulgakov", 1891, 5, 15, 12, 0, "Kiev", "UA")
        self.turkish_subject = AstrologicalSubjectFactory.from_standard("Mehmet Oz", 1960, 6, 11, 12, 0, "Istanbul", "TR")
        self.german_subject = AstrologicalSubjectFactory.from_standard("Albert Einstein", 1879, 3, 14, 11, 30, "Ulm", "DE")
        self.hindi_subject = AstrologicalSubjectFactory.from_standard("Amitabh Bachchan", 1942, 10, 11, 4, 0, "Allahabad", "IN")

        # Composite Chart
        self.angelina_jolie = AstrologicalSubjectFactory.from_standard("Angelina Jolie", 1975, 6, 4, 9, 9, "Los Angeles", "US", lng=-118.15, lat=34.03, tz_str="America/Los_Angeles")
        self.brad_pit = AstrologicalSubjectFactory.from_standard("Brad Pitt", 1963, 12, 18, 6, 31, "Shawnee", "US", lng=-96.56, lat=35.20, tz_str="America/Chicago")
