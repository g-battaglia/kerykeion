...
Usage:
    pytest tests/charts/test_parametrized.py -v
    pytest tests/charts/test_parametrized.py -k "temporal" -v
    pytest tests/charts/test_parametrized.py -k "geographic" -v
    pytest tests/charts/test_parametrized.py -k "cross" -v
"""
