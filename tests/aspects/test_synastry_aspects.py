...
class TestSynastryAspects:
    def setup_class(self):
        ...
        self.synastry_relevant_aspects = AspectsFactory.dual_chart_aspects(
    ...
    def test_relevant_aspects(self):
        for i, aspect in enumerate(self.expected_relevant_aspects):
            ...
            assert self.synastry_relevant_aspects[i]["p1_speed"] == approx(aspect["p1_speed"], abs=1e-2)
            assert self.synastry_relevant_aspects[i]["p2_speed"] == approx(aspect["p2_speed"], abs=1e-2)
