...
class TestNatalAspects:
    ...
    def test_relevant_aspects(self):
        for i, aspect in enumerate(self.expected_relevant_aspects):
            ...
            assert round(self.synastry_relevant_aspects[i]["p1_abs_pos"], 3) == round(aspect["p1_abs_pos"], 3)
            ...
            assert round(self.synastry_relevant_aspects[i]["diff"], 3) == round(aspect["diff"], 3)
    ...
    def test_all_aspects(self):
        for i, aspect in enumerate(self.expected_all_aspects):
            ...
            assert round(self.synastry_all_aspects[i]["p1_abs_pos"], 3) == round(aspect["p1_abs_pos"], 3)
            ...
            assert round(self.synastry_all_aspects[i]["diff"], 3) == round(aspect["diff"], 3)
