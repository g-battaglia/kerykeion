...
class TestKrInstance:
    ...
    def test_sun(self):
        ...
        assert self.subject.sun.position == self.expected_output["sun"]["position"]
        assert self.subject.sun.abs_pos == self.expected_output["sun"]["abs_pos"]
    ...
    def test_moon(self):
        ...
        assert self.subject.moon.position == self.expected_output["moon"]["position"]
        assert self.subject.moon.abs_pos == self.expected_output["moon"]["abs_pos"]
    ...
    def test_mercury(self):
        ...
        assert self.subject.mercury.position == self.expected_output["mercury"]["position"]
        assert self.subject.mercury.abs_pos == self.expected_output["mercury"]["abs_pos"]
    ...
    def test_venus(self):
        ...
        assert self.subject.venus.position == self.expected_output["venus"]["position"]
        assert self.subject.venus.abs_pos == self.expected_output["venus"]["abs_pos"]
    ...
    def test_mars(self):
        ...
        assert self.subject.mars.position == self.expected_output["mars"]["position"]
        assert self.subject.mars.abs_pos == self.expected_output["mars"]["abs_pos"]
    ...
    def test_jupiter(self):
        ...
        assert self.subject.jupiter.position == self.expected_output["jupiter"]["position"]
        assert self.subject.jupiter.abs_pos == self.expected_output["jupiter"]["abs_pos"]
    ...
    def test_saturn(self):
        ...
        assert self.subject.saturn.position == self.expected_output["saturn"]["position"]
        assert self.subject.saturn.abs_pos == self.expected_output["saturn"]["abs_pos"]
    ...
    def test_uranus(self):
        ...
        assert self.subject.uranus.position == self.expected_output["uranus"]["position"]
        assert self.subject.uranus.abs_pos == self.expected_output["uranus"]["abs_pos"]
    ...
    def test_neptune(self):
        ...
        assert self.subject.neptune.position == self.expected_output["neptune"]["position"]
        assert self.subject.neptune.abs_pos == self.expected_output["neptune"]["abs_pos"]
    ...
    def test_pluto(self):
        ...
        assert self.subject.pluto.position == self.expected_output["pluto"]["position"]
        assert self.subject.pluto.abs_pos == self.expected_output["pluto"]["abs_pos"]
    ...
    def test_mean_node(self):
        ...
        assert self.subject.mean_node.position == self.expected_output["mean_node"]["position"]
        assert self.subject.mean_node.abs_pos == self.expected_output["mean_node"]["abs_pos"]
    ...
    def test_true_node(self):
        ...
        assert self.subject.true_node.position == self.expected_output["true_node"]["position"]
        assert self.subject.true_node.abs_pos == self.expected_output["true_node"]["abs_pos"]
    ...
    def test_first_house(self):
        ...
        assert self.subject.first_house.position == self.expected_output["first_house"]["position"]
        assert self.subject.first_house.abs_pos == self.expected_output["first_house"]["abs_pos"]
    ...
    def test_second_house(self):
        ...
        assert self.subject.second_house.position == self.expected_output["second_house"]["position"]
        assert self.subject.second_house.abs_pos == self.expected_output["second_house"]["abs_pos"]
    ...
    def test_third_house(self):
        ...
        assert self.subject.third_house.position == self.expected_output["third_house"]["position"]
        assert self.subject.third_house.abs_pos == self.expected_output["third_house"]["abs_pos"]
    ...
    def test_fourth_house(self):
        ...
        assert self.subject.fourth_house.position == self.expected_output["fourth_house"]["position"]
        assert self.subject.fourth_house.abs_pos == self.expected_output["fourth_house"]["abs_pos"]
    ...
    def test_fifth_house(self):
        ...
        assert self.subject.fifth_house.position == self.expected_output["fifth_house"]["position"]
        assert self.subject.fifth_house.abs_pos == self.expected_output["fifth_house"]["abs_pos"]
    ...
    def test_sixth_house(self):
        ...
        assert self.subject.sixth_house.position == self.expected_output["sixth_house"]["position"]
        assert self.subject.sixth_house.abs_pos == self.expected_output["sixth_house"]["abs_pos"]
    ...
    def test_seventh_house(self):
        ...
        assert self.subject.seventh_house.position == self.expected_output["seventh_house"]["position"]
        assert self.subject.seventh_house.abs_pos == self.expected_output["seventh_house"]["abs_pos"]
    ...
    def test_eighth_house(self):
        ...
        assert self.subject.eighth_house.position == self.expected_output["eighth_house"]["position"]
        assert self.subject.eighth_house.abs_pos == self.expected_output["eighth_house"]["abs_pos"]
    ...
    def test_ninth_house(self):
        ...
        assert self.subject.ninth_house.position == self.expected_output["ninth_house"]["position"]
        assert self.subject.ninth_house.abs_pos == self.expected_output["ninth_house"]["abs_pos"]
    ...
    def test_tenth_house(self):
        ...
        assert self.subject.tenth_house.position == self.expected_output["tenth_house"]["position"]
        assert self.subject.tenth_house.abs_pos == self.expected_output["tenth_house"]["abs_pos"]
    ...
    def test_eleventh_house(self):
        ...
        assert self.subject.eleventh_house.position == self.expected_output["eleventh_house"]["position"]
        assert self.subject.eleventh_house.abs_pos == self.expected_output["eleventh_house"]["abs_pos"]
    ...
    def test_twelfth_house(self):
        ...
        assert self.subject.twelfth_house.position == self.expected_output["twelfth_house"]["position"]
        assert self.subject.twelfth_house.abs_pos == self.expected_output["twelfth_house"]["abs_pos"]
